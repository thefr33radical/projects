...
select 3, 'biryani', 3, 'rice and chicken', 20, 60, 4, 3, 'mix masala and chicken with curd and add flavours make dum in cooker', '',3, 'rahul', 1 , '2018-07-01 11:01:22';

select * from recipes.recipe_main;

insert into recipes.categories
select 3, 'ChilliEntree', 'Main course';

select * from recipes.recipe_main;

insert into recipes.recipe_main
select 4, 'Chicken Fried Rice', 4, 'Chicken, rice and eggs', 20, 35, 3, 2, 'Stir fry rice chicken and shredded eggs', '', 4, 'unknown', 2, '2018-07-01 16:24:56';
...
select 4,'allrecipes.com','website','http://www.allrecipes.com';
...
Values 
(20,'chicken thighs boneless and skinless',null),
(21,'Ghee',null),
(22,'black pepper',null),
(23,'cayenne pepper',null),
(24,'onions',null),
(25,'tomatoes',null),
(26,'ginger garlic paste',null), 
(27,'Basmati Rice',null);

insert into recipes.food_warnings
select 4, 20, 'Gluten sensitivity',null;

insert into recipes.rec_nutrition
select 3, 4, 300, 50, 95, 60, 10, 110, 40, 80, 75;

insert into recipes.substitutions
select 2,20,1, 'use two instead of 4';

insert into recipes.rec_comments
select 1, 3, '2018-07-01 18:13:36','add more black pepper to make it spicy';
...
Select recipe_desc from recipes.recipe_main where recipe_id = 3;
