...
def Lgboost(data):
    ...
    try:
        ...
        logging.info("Train "+str(math.sqrt(mean_squared_error(y_train_pred, y_train))))
        logging.info("Test "+str(math.sqrt(mean_squared_error(y_pred, y_test))))
        ...
        results=pd.DataFrame({"actual":y_test["SubAffiliateCost"],"LGBM":y_pred})
